      ...
      <figure className="photo-card__container">
        ...
        <figcaption className="photo-card__info">
          ...
          <div className="photo-card__like-container">
            <button
              className={`photo-card__btn photo-card__btn_like  ${
                isLiked ? "photo-card__btn_like_active" : ""
              }`}
              type="button"
        ...
        <button
          className={`photo-card__btn photo-card__btn_delete ${
            isOwn ? "photo-card__btn_delete_visible" : ""
          }`}
          type="button"
